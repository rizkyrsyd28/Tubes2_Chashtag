...
namespace Stima2
{
    public class DFS
    {
        ...
        {
            return this.theGraph.getNumOfNodes();
        }

        public int getSizeX()
        {
            return this.theGraph.getSizeGrafX();
        }

        public int getSizeY()
        {
            return this.theGraph.getSizeGrafY();
        }

        public char[,] getMatrix()
        {
            return theGraph.getMap();
        }
        ...
        public List<string> getGoPath()
        {
            ...
            for (int i = 0; i < this.DFSPath.Count; i++){
                goPath.Add(this.DFSPath[this.DFSPath.Count - i - 1].Item3);
            }
            return goPath;
        }
        public List<string> getBackPath()
        {
            ...
            for (int i = 0; i < this.returnPath.Count; i++){
                goPath.Add(this.returnPath[i].Item3);
            }
            return goPath;
        }
        ...
        //public void driver(string fileName)
        //{
        //    Graph _graph = new Graph(fileName);
        //    _graph.setUpGraph();
        //}
